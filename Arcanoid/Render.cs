...
namespace Arcanoid
{
    public class Render
    {
        ...
        private string _textureDir = "Textures";
        private string _textureImage = "TexturePack.png";
        ...
        {
            var x = Convert.ToInt32(block.Position.X * _scale.X);
            var y = Convert.ToInt32(block.Position.Y * _scale.Y);
            var height = Convert.ToInt32(block.Height * _scale.Y);
            var width = Convert.ToInt32(block.Width * _scale.X);
        ...
        private void DrawBallAsRectangle(Graphics graph)
        {
            ...
            {
                X = Convert.ToInt32(_gameState.Ball.Position.X * _scale.X),
                Y = Convert.ToInt32(_gameState.Ball.Position.Y * _scale.Y),
                Height = Convert.ToInt32(_gameState.Ball.Diameter * _scale.Y),
                Width = Convert.ToInt32(_gameState.Ball.Diameter * _scale.X),
            };
        ...
        private void DrawPlatformAsRectangle(Graphics graph)
        {
            ...
            {
                X = Convert.ToInt32(_gameState.Platform.Position.X * _scale.X),
                Y = Convert.ToInt32(_gameState.Platform.Position.Y * _scale.Y),
                Height = Convert.ToInt32(_gameState.Platform.Height * _scale.Y),
                Width = Convert.ToInt32(_gameState.Platform.Width * _scale.X)
            };
        ...
        {
            var blockHeight = Convert.ToInt32(20 * _scale.Y);
            var blockWidth = Convert.ToInt32(40 * _scale.X);
            ...
            texture1.TextureBrush = GetTextureBrush(textureRect1, rect.Width, rect.Height, _textureImage);
            ...
            texture2.TextureBrush = GetTextureBrush(textureRect2, rect.Width, rect.Height, _textureImage);
            ...
            texture3.TextureBrush = GetTextureBrush(textureRect3, rect.Width, rect.Height, _textureImage);
            ...
            texture4.TextureBrush = GetTextureBrush(textureRect4, rect.Width, rect.Height, _textureImage);
            ...
            texture5.TextureBrush = GetTextureBrush(textureRect5, rect.Width, rect.Height, _textureImage);
            ...
            texture6.TextureBrush = GetTextureBrush(textureRect6, rect.Width, rect.Height, _textureImage);
            ...
            texture7.TextureBrush = GetTextureBrush(textureRect7, rect.Width, rect.Height, _textureImage);
            ...
            texture8.TextureBrush = GetTextureBrush(textureRect8, rect.Width, rect.Height, _textureImage);
        ...
        {
            var path = System.IO.Path.Combine(Environment.CurrentDirectory, _textureDir, textureImage);
        ...
        public void ScaleSize(int mainWindowHeight, int mainWindowWidth, int virtualHeight, int virtualWidth)
        {
            ...
            _scale.Y = height / virtualHeight;
            _scale.X = width / virtualWidth;
        }
    }
}
